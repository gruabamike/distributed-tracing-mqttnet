...
using SmartReplenishment.Services.NotificationMail.Instrumentation;

namespace SmartReplenishment.Services.NotificationMail.BackgroundServices;
...
public class Worker : BackgroundService
{
  ...
  private async Task OnApplicationMessageReceivedAsync(MqttApplicationMessageReceivedEventArgs args)
  {
    ...
    using var activity = ActivitySourceProvider.ActivitySource.StartActivity("Mail");
